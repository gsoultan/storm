...
func (g *gen) softDeleteFns(pk []colInfo) {
	...
	g.p("func Delete(ctx context.Context, ex runtime.Executor, %s) error {", sigs)
	...
	g.p("// spelled Delete.")
	g.p("func HardDelete(ctx context.Context, ex runtime.Executor, %s) error {", sigs)
	...
	g.p("func Restore(ctx context.Context, ex runtime.Executor, %s) error {", sigs)
