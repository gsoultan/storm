...
func batchTopByOrgIDWindowSQL(order []Sort) string {
	...
	sql := runtime.SpliceOrder("SELECT \"id\", \"org_id\", \"email\", \"name\", \"age\", \"status\", \"created_at\", \"updated_at\" FROM (SELECT \"id\", \"org_id\", \"email\", \"name\", \"age\", \"status\", \"created_at\", \"updated_at\", row_number() OVER (PARTITION BY \"org_id\"\x00order\x00) AS \"_raorm_rn\" FROM \"users\" WHERE \"org_id\" = ANY($1)) \"_raorm_t\" WHERE \"_raorm_rn\" <= $2", terms, " ORDER BY ", ", ")
...
func batchTopByOrgIDLateralSQL(order []Sort) string {
	...
	sql := runtime.SpliceOrder("SELECT \"_raorm_c\".\"id\", \"_raorm_c\".\"org_id\", \"_raorm_c\".\"email\", \"_raorm_c\".\"name\", \"_raorm_c\".\"age\", \"_raorm_c\".\"status\", \"_raorm_c\".\"created_at\", \"_raorm_c\".\"updated_at\" FROM unnest($1::uuid[]) AS \"_raorm_p\"(\"_raorm_k\") CROSS JOIN LATERAL (SELECT \"id\", \"org_id\", \"email\", \"name\", \"age\", \"status\", \"created_at\", \"updated_at\" FROM \"users\" WHERE \"org_id\" = \"_raorm_p\".\"_raorm_k\"\x00order\x00 LIMIT $2) \"_raorm_c\"", terms, " ORDER BY ", ", ")
