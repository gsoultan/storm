...
func (_u *UserUpdate) SetOrgID(v uuid.UUID) *UserUpdate {
	_u.mutation.SetOrgID(v)
	return _u
}

// SetNillableOrgID sets the "org_id" field if the given value is not nil.
func (_u *UserUpdate) SetNillableOrgID(v *uuid.UUID) *UserUpdate {
	if v != nil {
		_u.SetOrgID(*v)
	}
	return _u
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.AgeCleared() {
		_spec.ClearField(user.FieldAge, field.TypeInt32)
	}
...
// SetOrgID sets the "org_id" field.
func (_u *UserUpdateOne) SetOrgID(v uuid.UUID) *UserUpdateOne {
	_u.mutation.SetOrgID(v)
	return _u
}

// SetNillableOrgID sets the "org_id" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableOrgID(v *uuid.UUID) *UserUpdateOne {
	if v != nil {
		_u.SetOrgID(*v)
	}
	return _u
...
func (_u *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`entbench: missing "User.id" for update`)}
	}
	...
	if fields := _u.fields; len(fields) > 0 {
		...
		for _, f := range fields {
			if !user.ValidColumn(f) {
				return nil, &ValidationError{Name: f, err: fmt.Errorf("entbench: invalid field %q for query", f)}
			}
			if f != user.FieldID {
