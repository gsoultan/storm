...
func (q Query) ActionEq(v string) Query            { return q.Where(Action.Eq(v)) }
func (q Query) ActionNotEq(v string) Query         { return q.Where(Action.NotEq(v)) }
func (q Query) ActionGt(v string) Query            { return q.Where(Action.Gt(v)) }
func (q Query) ActionGte(v string) Query           { return q.Where(Action.Gte(v)) }
func (q Query) ActionLt(v string) Query            { return q.Where(Action.Lt(v)) }
func (q Query) ActionLte(v string) Query           { return q.Where(Action.Lte(v)) }
func (q Query) ActionEqLower(v string) Query       { return q.Where(Action.EqLower(v)) }
func (q Query) ActionLike(v string) Query          { return q.Where(Action.Like(v)) }
func (q Query) ActionILike(v string) Query         { return q.Where(Action.ILike(v)) }
func (q Query) ActionIn(v ...string) Query         { return q.Where(Action.In(v...)) }
func (q Query) ActionNotIn(v ...string) Query      { return q.Where(Action.NotIn(v...)) }
func (q Query) SubjectTypeEq(v string) Query       { return q.Where(SubjectType.Eq(v)) }
func (q Query) SubjectTypeNotEq(v string) Query    { return q.Where(SubjectType.NotEq(v)) }
func (q Query) SubjectTypeGt(v string) Query       { return q.Where(SubjectType.Gt(v)) }
func (q Query) SubjectTypeGte(v string) Query      { return q.Where(SubjectType.Gte(v)) }
func (q Query) SubjectTypeLt(v string) Query       { return q.Where(SubjectType.Lt(v)) }
func (q Query) SubjectTypeLte(v string) Query      { return q.Where(SubjectType.Lte(v)) }
func (q Query) SubjectTypeEqLower(v string) Query  { return q.Where(SubjectType.EqLower(v)) }
func (q Query) SubjectTypeLike(v string) Query     { return q.Where(SubjectType.Like(v)) }
func (q Query) SubjectTypeILike(v string) Query    { return q.Where(SubjectType.ILike(v)) }
func (q Query) SubjectTypeIn(v ...string) Query    { return q.Where(SubjectType.In(v...)) }
func (q Query) SubjectTypeNotIn(v ...string) Query { return q.Where(SubjectType.NotIn(v...)) }
func (q Query) SubjectIDEq(v [16]byte) Query       { return q.Where(SubjectID.Eq(v)) }
func (q Query) SubjectIDNotEq(v [16]byte) Query    { return q.Where(SubjectID.NotEq(v)) }
func (q Query) SubjectIDIn(v ...[16]byte) Query    { return q.Where(SubjectID.In(v...)) }
func (q Query) SubjectIDNotIn(v ...[16]byte) Query { return q.Where(SubjectID.NotIn(v...)) }

const selectPrefix = `SELECT "id", "created_at", "updated_at", "action", "subject_type", "subject_id" FROM "audit_logs"`
...
var orderTable = [nCols][4]string{
	...
	{ // action
		"\"action\"",
		"\"action\" DESC",
		"\"action\" ASC NULLS FIRST",
		"\"action\" DESC NULLS LAST",
	},
	{ // subject_type
		"\"subject_type\"",
		"\"subject_type\" DESC",
		"\"subject_type\" ASC NULLS FIRST",
		"\"subject_type\" DESC NULLS LAST",
	},
	{ // subject_id
		"\"subject_id\"",
		"\"subject_id\" DESC",
		"\"subject_id\" ASC NULLS FIRST",
		"\"subject_id\" DESC NULLS LAST",
	},
}
...
var fragTable = [6][28]runtime.Frag{
	...
	{ // subject_type
		...
		{A: "\"subject_type\" < $", B: ""},
		{A: "\"subject_type\" <= $", B: ""},
		{A: "lower(\"subject_type\") = lower($", B: ")"},
		{A: "\"subject_type\" LIKE $", B: ""},
		{A: "\"subject_type\" ILIKE $", B: ""},
		{},
		{},
		{},
		{},
		{},
		{A: "\"subject_type\" = ANY($", B: ")"},
		{A: "\"subject_type\" <> ALL($", B: ")"},
		{},
		{},
		{},
		{},
...
func scan(rv [][]byte, r *Row, sl *runtime.Slab) error {
	...
	r.Action = sl.Str(rv[3])
	r.SubjectType = sl.Str(rv[4])
	copy(r.SubjectID[:], rv[5])
	return nil
}
...
const insertSQL = `INSERT INTO "audit_logs" ("id", "created_at", "updated_at", "action", "subject_type", "subject_id") VALUES ($1, $2, $3, $4, $5, $6) RETURNING "id", "created_at", "updated_at", "action", "subject_type", "subject_id"`
...
const (
	...
	dAction      uint64 = 1 << 1
	dSubjectType uint64 = 1 << 2
	dSubjectID   uint64 = 1 << 3
)
...
var exprFrags = [nUpdatable]runtime.Frag{
	...
	{},                                   // action has no server-side form
	{},                                   // subject_type has no server-side form
	{},                                   // subject_id has no server-side form
}
...
const (
	...
	iAction      uint64 = 1 << 3
	iSubjectType uint64 = 1 << 4
	iSubjectID   uint64 = 1 << 5
)
...
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"action\", \"subject_type\", \"subject_id\""
...
const updReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"action\", \"subject_type\", \"subject_id\""
...
func (m *Mut) SetAction(v string) {
	m.row.Action = v
	m.dirty |= dAction
	m.expr &^= dAction
}

func (m *Mut) SetSubjectType(v string) {
	m.row.SubjectType = v
	m.dirty |= dSubjectType
	m.expr &^= dSubjectType
}

func (m *Mut) SetSubjectID(v [16]byte) {
	m.row.SubjectID = v
	m.dirty |= dSubjectID
	m.expr &^= dSubjectID
}
...
func (n *Ins) SetAction(v string) {
	n.row.Action = v
	n.set |= iAction
}

func (n *Ins) SetSubjectType(v string) {
	n.row.SubjectType = v
	n.set |= iSubjectType
}

func (n *Ins) SetSubjectID(v [16]byte) {
	n.row.SubjectID = v
	n.set |= iSubjectID
}
...
func assignable(i uint8, mask uint64) []string {
	...
	case 0:
		...
		if mask&(1<<4) != 0 {
			set = append(set, "subject_type")
		}
		if mask&(1<<5) != 0 {
			set = append(set, "subject_id")
		}
	}
	return set
}
...
var assignFor = map[string]string{
	...
	"subject_type": "\"subject_type\" = EXCLUDED.\"subject_type\"",
	"subject_id":   "\"subject_id\" = EXCLUDED.\"subject_id\"",
}
...
func (n *Ins) Insert(ctx context.Context, ex runtime.Executor) (Row, error) {
	...
	for i := 0; i < nInsertable; i++ {
		...
		case 3:
			args = append(args, n.row.Action)
		case 4:
			args = append(args, n.row.SubjectType)
		case 5:
			args = append(args, n.row.SubjectID)
		}
	}
	var out Row
...
func Insert(ctx context.Context, ex runtime.Executor, r *Row) error {
	...
	args = append(args, r.SubjectType)
	args = append(args, r.SubjectID)
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "audit_logs", copyCols, src)
}
...
func (m *Mut) UpdateOp() (runtime.BatchOp, bool) {
	...
	for i := 0; i < nUpdatable; i++ {
		...
		case 1:
			args = append(args, m.row.Action)
		case 2:
			args = append(args, m.row.SubjectType)
		case 3:
			args = append(args, m.row.SubjectID)
		}
	}
