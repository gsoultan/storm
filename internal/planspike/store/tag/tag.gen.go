...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "name" FROM "tags"`
const countPrefix = `SELECT count(*) FROM "tags"`
const existsPrefix = `SELECT 1 FROM "tags"`
...
const insertSQL = `INSERT INTO "tags" ("id", "created_at", "updated_at", "name") VALUES ($1, $2, $3, $4) RETURNING "id", "created_at", "updated_at", "name"`

const updatePrefix = `UPDATE "tags" SET `
const deletePrefix = `DELETE FROM "tags"`
...
const insPrefix = "INSERT INTO \"tags\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"name\""
...
const updReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"name\""
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "tags", copyCols, src)
}
