...
var fragTable = [8][13]runtime.Frag{
	...
	{ // relation Comments (pseudo-column)
		...
		{},
		{},
		{A: "EXISTS (SELECT 1 FROM \"comments\" AS \"_raorm_e\" WHERE \"_raorm_e\".\"post_id\" = \"posts\".\"id\")"},
		{A: "NOT EXISTS (SELECT 1 FROM \"comments\" AS \"_raorm_e\" WHERE \"_raorm_e\".\"post_id\" = \"posts\".\"id\")"},
	},
}
...
func batchTopByAuthorIDWindowSQL(order []Sort) string {
	...
	sql := runtime.SpliceOrder("SELECT \"id\", \"created_at\", \"updated_at\", \"title\", \"body\", \"published_at\", \"author_id\" FROM (SELECT \"id\", \"created_at\", \"updated_at\", \"title\", \"body\", \"published_at\", \"author_id\", row_number() OVER (PARTITION BY \"author_id\"\x00order\x00) AS \"_raorm_rn\" FROM \"posts\" WHERE \"author_id\" = ANY($1)) \"_raorm_t\" WHERE \"_raorm_rn\" <= $2", terms, " ORDER BY ", ", ")
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "posts", copyCols, src)
}
