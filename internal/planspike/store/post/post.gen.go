...
var fragTable = [8][27]runtime.Frag{
	...
	{ // relation Comments (pseudo-column)
		...
		{},
		{},
		{A: "EXISTS (SELECT 1 FROM \"comments\" AS \"_storm_e\" WHERE \"_storm_e\".\"post_id\" = \"posts\".\"id\")"},
		{A: "NOT EXISTS (SELECT 1 FROM \"comments\" AS \"_storm_e\" WHERE \"_storm_e\".\"post_id\" = \"posts\".\"id\")"},
	},
}
