...
var fragTable = [8][13]runtime.Frag{
	...
	{ // relation Replies (pseudo-column)
		...
		{},
		{},
		{A: "EXISTS (SELECT 1 FROM \"comments\" AS \"_raorm_e\" WHERE \"_raorm_e\".\"parent_id\" = \"comments\".\"id\")"},
		{A: "NOT EXISTS (SELECT 1 FROM \"comments\" AS \"_raorm_e\" WHERE \"_raorm_e\".\"parent_id\" = \"comments\".\"id\")"},
	},
}
...
func batchTopByParentIDWindowSQL(order []Sort) string {
	...
	sql := runtime.SpliceOrder("SELECT \"id\", \"created_at\", \"updated_at\", \"body\", \"post_id\", \"author_id\", \"parent_id\" FROM (SELECT \"id\", \"created_at\", \"updated_at\", \"body\", \"post_id\", \"author_id\", \"parent_id\", row_number() OVER (PARTITION BY \"parent_id\"\x00order\x00) AS \"_raorm_rn\" FROM \"comments\" WHERE \"parent_id\" = ANY($1)) \"_raorm_t\" WHERE \"_raorm_rn\" <= $2", terms, " ORDER BY ", ", ")
...
func batchTopByParentIDLateralSQL(order []Sort) string {
	...
	sql := runtime.SpliceOrder("SELECT \"_raorm_c\".\"id\", \"_raorm_c\".\"created_at\", \"_raorm_c\".\"updated_at\", \"_raorm_c\".\"body\", \"_raorm_c\".\"post_id\", \"_raorm_c\".\"author_id\", \"_raorm_c\".\"parent_id\" FROM unnest($1::uuid[]) AS \"_raorm_p\"(\"_raorm_k\") CROSS JOIN LATERAL (SELECT \"id\", \"created_at\", \"updated_at\", \"body\", \"post_id\", \"author_id\", \"parent_id\" FROM \"comments\" WHERE \"parent_id\" = \"_raorm_p\".\"_raorm_k\"\x00order\x00 LIMIT $2) \"_raorm_c\"", terms, " ORDER BY ", ", ")
...
func batchTopByPostIDWindowSQL(order []Sort) string {
	...
	sql := runtime.SpliceOrder("SELECT \"id\", \"created_at\", \"updated_at\", \"body\", \"post_id\", \"author_id\", \"parent_id\" FROM (SELECT \"id\", \"created_at\", \"updated_at\", \"body\", \"post_id\", \"author_id\", \"parent_id\", row_number() OVER (PARTITION BY \"post_id\"\x00order\x00) AS \"_raorm_rn\" FROM \"comments\" WHERE \"post_id\" = ANY($1)) \"_raorm_t\" WHERE \"_raorm_rn\" <= $2", terms, " ORDER BY ", ", ")
...
func batchTopByPostIDLateralSQL(order []Sort) string {
	...
	sql := runtime.SpliceOrder("SELECT \"_raorm_c\".\"id\", \"_raorm_c\".\"created_at\", \"_raorm_c\".\"updated_at\", \"_raorm_c\".\"body\", \"_raorm_c\".\"post_id\", \"_raorm_c\".\"author_id\", \"_raorm_c\".\"parent_id\" FROM unnest($1::uuid[]) AS \"_raorm_p\"(\"_raorm_k\") CROSS JOIN LATERAL (SELECT \"id\", \"created_at\", \"updated_at\", \"body\", \"post_id\", \"author_id\", \"parent_id\" FROM \"comments\" WHERE \"post_id\" = \"_raorm_p\".\"_raorm_k\"\x00order\x00 LIMIT $2) \"_raorm_c\"", terms, " ORDER BY ", ", ")
...
const descendSQL = `WITH RECURSIVE "_raorm_r" AS (SELECT "id", "created_at", "updated_at", "body", "post_id", "author_id", "parent_id", 1 AS "_raorm_d", ARRAY["id"] AS "_raorm_path" FROM "comments" WHERE "id" = ANY($1) UNION ALL SELECT "_raorm_rc"."id", "_raorm_rc"."created_at", "_raorm_rc"."updated_at", "_raorm_rc"."body", "_raorm_rc"."post_id", "_raorm_rc"."author_id", "_raorm_rc"."parent_id", "_raorm_r"."_raorm_d" + 1, "_raorm_r"."_raorm_path" || "_raorm_rc"."id" FROM "comments" "_raorm_rc" JOIN "_raorm_r" ON "_raorm_rc"."parent_id" = "_raorm_r"."id" WHERE "_raorm_r"."_raorm_d" < $2 AND NOT "_raorm_rc"."id" = ANY("_raorm_r"."_raorm_path")) SELECT "id", "created_at", "updated_at", "body", "post_id", "author_id", "parent_id" FROM "_raorm_r"`
...
const ascendSQL = `WITH RECURSIVE "_raorm_r" AS (SELECT "id", "created_at", "updated_at", "body", "post_id", "author_id", "parent_id", 1 AS "_raorm_d", ARRAY["id"] AS "_raorm_path" FROM "comments" WHERE "id" = ANY($1) UNION ALL SELECT "_raorm_rc"."id", "_raorm_rc"."created_at", "_raorm_rc"."updated_at", "_raorm_rc"."body", "_raorm_rc"."post_id", "_raorm_rc"."author_id", "_raorm_rc"."parent_id", "_raorm_r"."_raorm_d" + 1, "_raorm_r"."_raorm_path" || "_raorm_rc"."id" FROM "comments" "_raorm_rc" JOIN "_raorm_r" ON "_raorm_r"."parent_id" = "_raorm_rc"."id" WHERE "_raorm_r"."_raorm_d" < $2 AND NOT "_raorm_rc"."id" = ANY("_raorm_r"."_raorm_path")) SELECT "id", "created_at", "updated_at", "body", "post_id", "author_id", "parent_id" FROM "_raorm_r"`
