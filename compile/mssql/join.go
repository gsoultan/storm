...
//
// The shape is standard SQL and carries over whole: SQL Server has JOIN, LEFT
// JOIN, table aliases and WITH. Unlike MySQL it also has everything the CTEs
// CONTAIN — a declared aggregation's GROUPING SETS and CUBE both exist here —
// so a join that materialises one is emitted rather than refused.
//
