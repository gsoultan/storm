...
func HasOrders() Pred   { return Pred{col: 5, op: opExists} }
func HasNoOrders() Pred { return Pred{col: 5, op: opNotExists} }
...
const selectPrefix = `SELECT "id", "created_at", "updated_at", "email", "name" FROM "customers"`
const countPrefix = `SELECT count(*) FROM "customers"`
const existsPrefix = `SELECT 1 FROM "customers"`
...
var fragTable = [6][28]runtime.Frag{
	...
	{ // relation Orders (pseudo-column)
		...
		{},
		{},
		{A: "EXISTS (SELECT 1 FROM \"orders\" AS \"_storm_e\" WHERE \"_storm_e\".\"customer_id\" = \"customers\".\"id\")"},
		{A: "NOT EXISTS (SELECT 1 FROM \"orders\" AS \"_storm_e\" WHERE \"_storm_e\".\"customer_id\" = \"customers\".\"id\")"},
	},
}
...
const insertSQL = `INSERT INTO "customers" ("id", "created_at", "updated_at", "email", "name") VALUES ($1, $2, $3, $4, $5) RETURNING "id", "created_at", "updated_at", "email", "name"`

const updatePrefix = `UPDATE "customers" SET `
const deletePrefix = `DELETE FROM "customers"`
...
const insPrefix = "INSERT INTO \"customers\""
const insReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"email\", \"name\""
...
const updReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"email\", \"name\""
...
func InsertAll(ctx context.Context, ex runtime.Executor, rows []Row) (int64, error) {
	...
	return ex.CopyFrom(ctx, "customers", copyCols, src)
}
