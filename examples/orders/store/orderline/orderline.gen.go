...
var fragTable = [7][28]runtime.Frag{
	{ // id
		{}, // opNone
		{A: "\"id\" = $", B: ""},
		{A: "\"id\" <> $", B: ""},
...
var exprFrags = [nUpdatable]runtime.Frag{
	...
	{},                                   // order_id has no server-side form
	{},                                   // product_id has no server-side form
	{A: "\"quantity\" = \"quantity\" + 1", B: ""}, // quantity = its own value plus one
	{}, // unit_price has no server-side form
}
...
const updReturning = " RETURNING \"id\", \"created_at\", \"updated_at\", \"order_id\", \"product_id\", \"quantity\", \"unit_price\""
...
// IncQuantity adds one to the column's OWN value, in the database.
//
