...
func batchTopByAuthorIDLateralSQL(order []Sort) string {
	...
	sql := runtime.SpliceOrder("SELECT \"_raorm_c\".\"id\", \"_raorm_c\".\"created_at\", \"_raorm_c\".\"updated_at\", \"_raorm_c\".\"title\", \"_raorm_c\".\"body\", \"_raorm_c\".\"published_at\", \"_raorm_c\".\"author_id\" FROM unnest($1::uuid[]) AS \"_raorm_p\"(\"_raorm_k\") CROSS JOIN LATERAL (SELECT \"id\", \"created_at\", \"updated_at\", \"title\", \"body\", \"published_at\", \"author_id\" FROM \"articles\" WHERE \"author_id\" = \"_raorm_p\".\"_raorm_k\"\x00order\x00 LIMIT $2) \"_raorm_c\"", terms, " ORDER BY ", ", ")
