...
var fragTable = [6][13]runtime.Frag{
	...
	{ // relation Articles (pseudo-column)
		...
		{},
		{},
		{A: "EXISTS (SELECT 1 FROM \"articles\" AS \"_raorm_e\" WHERE \"_raorm_e\".\"author_id\" = \"authors\".\"id\")"},
		{A: "NOT EXISTS (SELECT 1 FROM \"articles\" AS \"_raorm_e\" WHERE \"_raorm_e\".\"author_id\" = \"authors\".\"id\")"},
	},
}
